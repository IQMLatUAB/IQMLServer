...
def fast_surfer_cnn(img_filename, save_as, logger, args):
    ...
    model.eval()
    prediction_probability_axial = torch.zeros((256, params_network["num_classes"], 256, 256), dtype=torch.float16)
    ...
    model.eval()
    prediction_probability_coronal = torch.zeros((256, params_network["num_classes"], 256, 256), dtype=torch.float16)
    ...
    model.eval()
    prediction_probability_sagittal = torch.zeros((256, params_network["num_classes"], 256, 256), dtype=torch.float16)
