...
%                     end
                    ...
                    filename = file(1:end-4) + "_t" + sprintf('%d', current_volume) + "_z" + sprintf('%03d', current_slice) + ".png";
                    ...
                    movefile(char(filename),'png_path');
...
%                 end
                ...
                filename = sprintf('%d', current_slice) + ".png";
