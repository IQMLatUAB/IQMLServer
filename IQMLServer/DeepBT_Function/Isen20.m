...
output_file_path = fullfile(pwd, 'Image_Analysis_Result/Output/BTK_segmentor/isen-20.nii.gz');
inverted_filegz_path = fullfile(pwd, 'Image_Analysis_Result/Output/BTK_segmentor/isen-20_inverted.nii.gz');
inverted_file_path = fullfile(pwd, 'Image_Analysis_Result/Output/BTK_segmentor/isen-20_inverted.nii');

cmd1 = ['cd ', BTK_path, '; python 0_preprocessing_batch.py'];
cmd2 = ['cd ', BTK_path, '; python segmentation_isen20.py'];
...
system(['rm -rf ', fullfile(pwd, 'Image_Analysis_Result/Output/BTK_preprocessor/Subject1')], '-echo');  
